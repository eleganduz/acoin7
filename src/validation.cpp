...
const std::string strMessageMagic = "Acoin7 Signed Message:\n";
...
bool CVerifyDB::VerifyDB(const CChainParams& chainparams, CCoinsView *coinsview, int nCheckLevel, int nCheckDepth)
{
    ...
    if (nCheckDepth <= 0)
        // Acoin7: suffices until year 10214. Didn't x4 value due to integer wrap around and upstream compatibility.
