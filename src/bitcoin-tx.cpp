...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s acoin7-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  acoin7-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded acoin7 transaction") + "\n" +
              "  acoin7-tx [options] -create [commands]   " + _("Create hex-encoded acoin7 transaction") + "\n" +
              "\n";
